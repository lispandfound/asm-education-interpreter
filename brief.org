...
You can see evidence of the sending, and of feedback below (note I have blurred
the names and profiles of those in question, as this brief exists on a public
forum they cannot be identified)

[[file:~/Pictures/Screenshots/img-2016-06-29-164448.png]]
Some feedback:
[[file:~/Pictures/Screenshots/img-2016-06-29-165345.png]]

However verbal feedback was collected on April 13th as well, which is placed in
quote blocks below
...
- The simple table of opcodes wasn't enough for them to get started :: I quickly
     ...
     example was one student (who can be identified as Stakeholder 1 or S1) who said

     #+BEGIN_QUOTE
     How do I work this? I can't tell what to do
     #+END_QUOTE

     or when I showed S1 how it works

     #+BEGIN_QUOTE
     Are you trying all the ways you can arrange the number 16 in binary?
     #+END_QUOTE
...
- Feedback was needed :: Feedback was needed for students to have any idea of
     ...
     of it's execution. This came as a result of my second stakeholder (S2) who said
    #+BEGIN_QUOTE
So, what did I just do?
    #+END_QUOTE

    This was not in the earliest version of the program, and based off feedback I added it in.
